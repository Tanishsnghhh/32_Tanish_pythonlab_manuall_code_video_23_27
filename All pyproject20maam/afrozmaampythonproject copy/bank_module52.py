#Write a program to create the Bank Module to perform the operations such as check the Balance, 
#withdraw and deposit the money in bank account and import the module in main file.
class ATM:
    __balance=50000
    __pin=0
    __name=""
